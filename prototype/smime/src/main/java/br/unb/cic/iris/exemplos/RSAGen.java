...
public class RSAGen {
	public static void main(String args[]) throws Exception {
		...
		BufferedOutputStream pubout = new BufferedOutputStream(new FileOutputStream("/home/pedro/pgp/dummy.pkr"));
		pkr.encode(pubout);
		pubout.close();

		// Generate private key, dump to file.
		PGPSecretKeyRing skr = krgen.generateSecretKeyRing();
		BufferedOutputStream secout = new BufferedOutputStream(new FileOutputStream("/home/pedro/pgp/dummy.skr"));
		skr.encode(secout);
		secout.close();
	}
	...
	public final static PGPKeyRingGenerator generateKeyRingGenerator(String id, char[] pass, int s2kcount) throws Exception {
		...
		signhashgen.setPreferredHashAlgorithms(false, new int[] { HashAlgorithmTags.SHA256, HashAlgorithmTags.SHA1, HashAlgorithmTags.SHA384, HashAlgorithmTags.SHA512,
